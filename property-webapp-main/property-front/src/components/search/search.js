        ...
        <div className="px-3 py-2 bg-primary">
            ...
            <form className="d-flex flex-column w-50">
                ...
                <div className="w-50 filters btn-group mb-3">
                    <button className="btn btn-secondary px-4">Area</button>
                    <button className="btn btn-secondary px-4">Agency</button>
                    <button className="btn btn-secondary px-4">Address</button>
                </div>
            </form>
        </div>
     );
